            ...
            {readOnly ? 
                data.map((item, index, array) =>
                    <tr key={index} className="mainRow">
                        ...
                        <td className={index % 2 == 0 ? "border-x-1 border-gray-400 bg-gray-100 text-gray-600 pl-1" : "border-x-1 border-gray-400 text-gray-600 pl-1"} style={index == array.length - 1 ? {borderBottom: "1px solid #9CA3AF"} : {borderBottom: "none"}}>{item.order}</td>
                    </tr>
                )
                :
                data.map((item, index, array) =>
